...
touch princess_leia.txt && echo echo "Help me, Obi-Wan…You’re my only hope." > princess_leia.txt
...
mv luke_skywalker.txt obi_wan.txt princess_leia.txt ~/Documents/General\ Assembly/homework/Star_Wars/star_wars/rebellion/millenium_falcon
