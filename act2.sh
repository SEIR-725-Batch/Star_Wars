...
# 6. Move luke_skywalker, obi_wan, and princess_leia into the millenium_falcon, respectively.
 mv ~/sei/homework/Star_Wars/rebellion/luke_skywalker.txt ~/sei/homework/Star_Wars/rebellion/millenium_falcon/
# 7. Move the millenium_falcon into the death_star.
mv ~/sei/homework/Star_Wars/rebellion/millenium_falcon ~/sei/homework/Star_Wars/empire/death_star/     