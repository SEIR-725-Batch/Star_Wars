...
princess_leia.txt && echo "Help me, Obi-Wan...You're my only hope." >> princess_leia.txt
...
mv ~/sei/repos/star_wars/rebellion/millenium_falcon ~/sei/repos/star_wars/empire/death_star
