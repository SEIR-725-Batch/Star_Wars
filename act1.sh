...
Star_Wars git:(master) mkdir star_wars/empire star_wars/rebellion
...
Star_Wars git:(master) ✗ echo "...heavy breathing..." >>echo "...heavy breathing..." >>empire/death_star/darth_vader.txt
