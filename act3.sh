...
cd death_star
mv millenium_falcon/* ~/seir725/repos/Star_Wars/star_wars/empire/death_star 
...
mv millenium_falcon ~/seir725/repos/Star_Wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/seir725/repos/Star_Wars/star_wars/rebellion
