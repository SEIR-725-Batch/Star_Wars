...
mv ~/sei/deliverables/Star_Wars/empire/death_star/millenium_falcon/* ~/sei/deliverables/Star_Wars/empire/death_star
...
mv darth_vader.txt darth_vader 
mv *.txt millenium_falcon/
mv darth_vader. darth_vader.txt
