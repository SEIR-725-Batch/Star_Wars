...
mv ~/Star_Wars/star_wars/empire/death_star/millenium_falcon/* ~/Star_Wars/star_wars/empire/death_star 
# 2. darth_vader has defeated obi_wan! Delete poor obi_wan.
cd ~/Star_Wars/star_wars/empire/death_star && rm obi_wan.txt
