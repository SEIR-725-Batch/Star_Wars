...
mv millenium_falcon/* ~/Documents/General\ Assembly/homework/Star_Wars/star_wars/empire/death_star
...
mv luke_skywalker.txt chewbacca.txt han_solo.txt princess_leia.txt ~/Documents/General\ Assembly/homework/Star_Wars/star_wars/empire/death_star/millenium_falcon 
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon ~/mv luke_skywalker.txt chewbacca.txt han_solo.txt princess_leia.txt ~/Documents/General\ Assembly/homework/Star_Wars/star_wars/rebellion 
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt ~/mv millenium_falcon ~/mv luke_skywalker.txt chewbacca.txt han_solo.txt princess_leia.txt ~/Documents/General\ Assembly/homework/Star_Wars/star_wars/rebellion
