...
mv ../empire/death_star/millenium_falcon/han_solo.txt ../empire/death_star/millenium_falcon/chewbacca.txt ../empire/death_star/millenium_falcon/princess_leia.txt ../empire/death_star/millenium_falcon/luke_skywalker.txt ../empire/death_star/millenium_falcon/obi_wan.txt ../empire/death_star
...
mv ./millenium_falcon ~/sei/deliverables/star_wars/star_wars/rebellion
