...
# Move the whole crew from the millenium_falcon directory into the death_star directory. HINT: * following a directory will grab all files/folders inside of a directory (directory/*)
 mv ~/Star_Wars/rebellion/millenium_falcon/* ~/
Star_Wars/empire/death_star
...
mv chewbacca.txt han_solo.txt luke_sky
walker.txt princess_leia.txt millenium_falcon
...
mv darth_vader.txt ~/Star_Wars/empire
