...
mv ~/sei/homework/Star_Wars/empire/death_star/millenium_falcon/* ~/sei/homework/Star_Wars/empire/death_star/
# 2. darth_vader has defeated obi_wan! Delete poor obi_wan.
rm ~/sei/homework/Star_Wars/empire/death_star/obi_wan.txt
...
mv ~/sei/homework/Star_Wars/empire/death_star/chewbacca.txt ~/sei/homework/Star_Wars/empire/death_star/millenium_falcon/
# 4. Move the millenium_falcon back into the rebellion directory.
mv ~/sei/homework/Star_Wars/empire/death_star/millenium_falcon ~/sei/homework/Star_Wars/rebellion/   
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv ~/sei/homework/Star_Wars/empire/death_star/darth_vader.txt  ~/sei/homework/Star_Wars/empire 
# 6. Thanks to his practice back home at Beggar’s Canyon, Luke blew up the death_star! Remove it from the galaxy!
rm -rf ~/sei/homework/Star_Wars/empire/death_star