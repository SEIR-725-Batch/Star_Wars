...
cd empire     mv death_star/millenium_falcon/* death_star
...
mv chewbacca.txt death_star     mv han_solo.txt death_star    mv luke_skywalker.txt death_star    mv princess_leia.txt death_star
# 4. Move the millenium_falcon back into the rebellion directory.
cd .. cd .. mv empire/death_star/millenium_falcon rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv empire/death_star/darth_vader empire
